...
ROUTING_RULES_FILE="rules/routes.txt"
TUN_CONFIG_FILE="src/data/tun.js"
OUTPUT_DIR="dist"
SKIP_REMOTE_RULES=0
...
build_script_artifact "$SOURCE_FILE" "$REGION_DATA_FILE" "$script_output_file" "$ROUTING_RULES_FILE" "$TUN_CONFIG_FILE"
