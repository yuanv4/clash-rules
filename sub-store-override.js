...
async function main(config = {}) {
  ...
  const groupOrder = ["Tailscale","🛑 广告过滤","🤖 国际 AI","🧑‍💻 开发服务","🎬 流媒体服务","🇨🇳 国内服务","🌐 国外服务","🐟 漏网之鱼","♻️ 自动选择(香港)","🛟 故障转移(台湾)"];
  ...
  config.rules = ["IP-CIDR,100.64.0.0/10,Tailscale,no-resolve","IP-CIDR,100.100.100.100/32,Tailscale,no-resolve","DOMAIN-SUFFIX,ts.net,Tailscale","RULE-SET,direct,DIRECT,no-resolve","RULE-SET,reject_domainset,🛑 广告过滤,no-resolve","RULE-SET,reject,🛑 广告过滤,no-resolve","RULE-SET,ai,🤖 国际 AI,no-resolve","RULE-SET,dev_services,🧑‍💻 开发服务,no-resolve","RULE-SET,streaming_services,🎬 流媒体服务,no-resolve","RULE-SET,cn_services,🇨🇳 国内服务,no-resolve","RULE-SET,foreign_services,🌐 国外服务,no-resolve","MATCH,🐟 漏网之鱼"];
